<template>
  <div class="app-container">
    ...
    <Drawer
      ...
      width="720"
    >
      <Form :label-width="100" :model="currentData" label-position="left">
        <el-row>
          <el-col :span="12">
            <FormItem label="ISBN">
        ...
        <el-row>
          <el-col :span="12">
            <FormItem label="出版社全称">
              <Select style="width:200px" v-model="currentData.publishingHouse">
                <Option :key="item.uuid" :value="item.publishingHouse" v-for="item in publishingHouseList">{{
          ...
          <el-col :span="12">
            <FormItem label="出版社补充">
              <Select style="width:200px" v-model="currentData.publishingHouseSupplement">
      ...
      <div class="demo-drawer-footer">
        <Button @click="drawer = false" style="margin-right: 8px">取消</Button>
        <Button @click="drawerCommit" type="primary">提交</Button>
      </div>
    </Drawer>
    <!-- 抽屉代码 添加 -->
    <Drawer
    ...
    >
      <Form :label-width="100" :model="addData" label-position="left">
        ...
        <el-row>
          <el-col :span="12">
            <FormItem label="出版社全称">
              <Select style="width:200px" v-model="addData.publishingHouse">
                <Option :key="item.uuid" :value="item.publishingHouse" v-for="item in publishingHouseList">{{
                  item.publishingHouse }}
                </Option>
              </Select>
          ...
          <el-col :span="12">
            <FormItem label="出版社补充">
              <Select style="width:200px" v-model="addData.publishingHouseSupplement">
                <Option value="集团自编">集团自编</Option>
                <Option value="其他类">其他类</Option>
                <Option value="英语类">英语类</Option>
                <Option value="两课类">两课类</Option>
      ...
      <div class="demo-drawer-footer">
        <Button @click="addDrawer = false" style="margin-right: 8px">取消</Button>
        <Button @click="addBook" type="primary">确认添加</Button>
      </div>
    </Drawer>
